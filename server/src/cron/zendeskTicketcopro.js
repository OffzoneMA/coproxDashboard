...
const zendeskTicketcopro = {

    start: async () => {
        console.log('Zendesk ticket start ...');
        logs.logExecution("zendeskTicketcopro");

        try {
            // Call controller function to fetch tickets
            const tickets = await zendeskController.getTicketsNotClosed({}, {
                        ...
                        if (ticket.custom_fields) {
                            ...
                            if (targetField && targetField.value !== null) {
                                ...
                                if (pattern.test(coproName)) {
                                    ...
                                    console.log('starting update ticket : ', ticket.id, ' With Organisation in Custom field : ', coproName);
                                    const updateData = {
                                        "ticket": {
                                            "subject": subject
                                        }
                                ...
                                console.log("Le champ copro est toujours vide");
                            }
                            await delay(1000);
                        }
                    }
...
module.exports = zendeskTicketcopro;
